...
const rewardCatalog = [
    {
        ...
        title: "음식",
        description:
            "면접 준비로 바쁜 하루, 간단한 커피와 간식으로 에너지를 충전하세요.",
        meta: "GS25, CU, 스타벅스",
        items: [
            {
                id: "gs25-coffee",
                name: "GS25 아메리카노",
                cost: 1,
                description: "시원한 아이스 아메리카노로 집중력 UP!",
                badge: "즉시 발급",
                gradient: "linear-gradient(135deg, #f2e4ec, #c9dbf2)",
                perks: ["24시간 사용 가능", "바로 바코드 발급"],
            },
            {
                id: "cu-latte",
                name: "CU 카페라떼",
                cost: 1,
                description: "부드러운 카페라떼 한 잔의 여유.",
                badge: "인기",
                gradient: "linear-gradient(135deg, #f6f3ff, #e0f5ff)",
                perks: ["전국 매장 사용", "즉시 발급"],
            },
            {
                id: "starbucks-ame",
                name: "스타벅스 아메리카노 T",
                cost: 1,
                description: "스타벅스에서 즐기는 진한 아메리카노.",
                badge: "프리미엄",
                gradient: "linear-gradient(135deg, #e7f8ff, #d8f2e5)",
                perks: ["전국 스타벅스 사용", "모바일 쿠폰"],
            },
        ],
    },
    {
